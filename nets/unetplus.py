...
# -------------------------------------Resunet+注意力机制+Min-aspp++++++++++++++++++++++++++++++++++++++
class ResUnet_att_aspp(nn.Module):
    def __init__(self, img_ch=3, num_classes=2):
        super(ResUnet_att_aspp, self).__init__()
        # 编码
...
class UNet_att_aspp(nn.Module):
    def __init__(self, img_ch=3, num_classes=2):
        super(UNet_att_aspp, self).__init__()
...
# 解码块
    ...
    def forward(self, x):
        ...
        d1 = F.softmax(d1, dim=1)
        return d1
# -------------------------------------unet+注意力机制+DeConvblock++++++++++++++++++++++++++++++++++++++
class UNet_att_DeConvblock(nn.Module):
    def __init__(self, img_ch=3, num_classes=2):
        super(UNet_att_DeConvblock, self).__init__()
...
# 解码块
    ...
    def forward(self, x):
        ...
        d1 = F.softmax(d1, dim=1)
        return d1
# -------------------------------------unet+注意力机制+GSConvjilian++++++++++++++++++++++++++++++++++++++
class UNet_att_GSConvjilian(nn.Module):
    def __init__(self, img_ch=3, num_classes=2):
        super(UNet_att_GSConvjilian, self).__init__()
